...
public class MD5 {
	...
	/**
	 * �����������Ա��MD5����������õ���3���������ݣ���ԭʼ��Cʵ���б����嵽MD5_CTX�ṹ��
	 */
	...
	/**
	 * md5Update��MD5����������̣�inbuf��Ҫ�任���ֽڴ���inputlen�ǳ��ȣ����������getMD5ofStr���ã�
	 * ����֮ǰ��Ҫ����md5init����˰�����Ƴ�private��
	 */
	...
	/**
	 * md5Memcpy��һ���ڲ�ʹ�õ�byte����Ŀ鿽����������input��inpos��ʼ��len���ȵ��ֽڿ�����output��outposλ�ÿ�ʼ
	 */
	...
	/**
	 * Decode��byte���鰴˳��ϳɳ�long���飬��Ϊjava��long������64bit�ģ�ֻ�ϳɵ�32bit����32bit���㣬
	 * ����ӦԭʼCʵ�ֵ���;
	 */
	...
	/**
	 * ��byte���ղ����������ŵ�ԭ��ģ���λ��������Ϊjavaû��unsigned����
	 */
	...
	/**
	 * byteHEX()��������һ��byte���͵���ת����ʮ�����Ƶ�ASCII��ʾ��java�е�byte��toString�޷�ʵ����һ��
	 */
